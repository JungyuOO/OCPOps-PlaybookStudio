...
def _prioritize_phrase_terms(terms: list[str]) -> list[str]:
    ...
    command_priority = {
        ...
        "oc create -f": 3,
        "oc edit hpa": 4,
        "oc delete localvolume": 5,
        "oc delete localvolumeset": 6,
        "oc delete localvolumediscovery": 7,
        "oc api-resources": 8,
        "oc get csr": 9,
        "oc adm certificate approve": 10,
        "oc adm top pods": 11,
        "oc apply -f": 12,
        "oc create deployment": 13,
        "oc describe service": 14,
        "oc get endpoints": 15,
        "oc get nodes": 16,
        "oc describe node": 17,
        "oc describe node <node-name>": 18,
    }
