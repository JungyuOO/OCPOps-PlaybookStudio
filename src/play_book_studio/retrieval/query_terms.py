...
def _prioritize_phrase_terms(terms: list[str]) -> list[str]:
    ...
    command_priority = {
        ...
        "oc delete localvolume": 12,
        "oc delete localvolumeset": 13,
        "oc delete localvolumediscovery": 14,
        "oc api-resources": 15,
        "oc get csr": 16,
        "oc adm certificate approve": 17,
        "oc adm top pods": 18,
        "oc apply -f": 19,
        "oc create deployment": 20,
        "oc describe service": 21,
        "oc get endpoints": 22,
        "oc get nodes": 23,
        "oc describe node": 24,
        "oc describe node <node-name>": 25,
    }
