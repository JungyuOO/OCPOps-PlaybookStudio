...
def _llm_runtime_signature(settings: Settings) -> tuple[Any, ...]:
    return (
        ...
        settings.openshift_lightspeed_base_url,
        settings.openshift_lightspeed_provider,
        settings.openshift_lightspeed_model,
        settings.openshift_lightspeed_timeout_seconds,
        settings.openshift_lightspeed_verify_tls,
    ...
    return {
        ...
        "runtime": {
            ...
            "openshift_lightspeed": {
                "configured": bool(settings.openshift_lightspeed_base_url),
                "base_url_present": bool(settings.openshift_lightspeed_base_url),
