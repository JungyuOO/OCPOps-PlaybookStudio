...
OFFICIAL_GOLD_EMBEDDING_CHUNKS_PATH = OFFICIAL_GOLD_CORPUS_DIR / "embeddings" / "embedding_chunks.jsonl"
OFFICIAL_GOLD_TEXT_LAYERS_PATH = OFFICIAL_GOLD_CORPUS_DIR / "text-layers" / "text_layers.jsonl"
